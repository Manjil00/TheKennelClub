...
cursor-pointer flex justify-center items-center'>The Kennel Club</h1>
    ...
    <div className={`bg-white absolute min-h-[30vh] left-0 top-[90%] w-full p-5 flex flex-col justify-end md:static md:flex md:min-h-fit md:w-auto gap-9 text-sm ${isNavOpen ? 'block' : 'hidden'}`}>
        ...
        <Link to="/login"><li className="border-2 border-purple-800 p-2 rounded-lg hover:text-white hover:bg-purple-800">Login</li></Link>
        <Link to="/register"><li className="border-2 border-purple-800 p-2 rounded-lg hover:text-white hover:bg-purple-800">Register</li></Link>
        </ul>
    </div>
    <div>
