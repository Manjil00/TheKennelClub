...
return (
    <div className='main w-full h-auto mt-10 flex justify-center items-center text-black`'>
        <div className="section w-[95%] h-auto bg-slate-200 rounded-xl p-5 flex flex-col justify-center items-center gap-5">

            <h1 className="privingplans text-4xl font-bold">Pricing Plans</h1>
